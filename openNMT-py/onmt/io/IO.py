...
def get_input_output_representation_level(symbol_representation):
    if symbol_representation == "word2word":
        src_representation = "word"
        tgt_representation = "word"
    elif symbol_representation == "char2char":
        src_representation = "char"
        tgt_representation = "char"
    elif symbol_representation == "word2char":
        src_representation = "word"
        tgt_representation = "char"

    return src_representation, tgt_representation
...
def build_dataset(fields, data_type, src_path, tgt_path, src_dir=None,
    ...
    src_representation, tgt_representation = get_input_output_representation_level(symbol_representation)
...
def _make_examples_nfeats_tpl(data_type, src_path, src_dir,
    ...
    if data_type == 'text':
        src_examples_iter, num_src_feats = \
            TextDataset.make_text_examples_nfeats_tpl(
                src_path, src_seq_length_trunc, "src", symbol_representation)
